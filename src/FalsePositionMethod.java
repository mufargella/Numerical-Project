...
public class FalsePositionMethod {
    ...
    public static void main(String[] args) {
        ...
        // Step 1: Start
        System.out.println("False Position Method for f(x) = x³ - x - 2");
        System.out.println("-------------------------------------------");

        // Step 3: Initial guesses (set to 1 and 2 as per example)
        double x0 = 1.0;
        double x1 = 2.0;
        ...
        do {
            // Step 5: Calculate new approximation using false position formula
        ...
        } while (!rootFound && Math.abs(f(x2)) > e);

        // Step 8: Display root
        System.out.println("\nRoot found at x = " + String.format("%.7f", x2));
        System.out.println("f(root) = " + String.format("%.7f", f(x2)));
